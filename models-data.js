...
window.MODEL_LAB = [
  {
    ...
    architecture: [
      ...
      { en: 'Global average pooling', es: 'Global average pooling' },
  ...
  },
  {
    ...
    fullName: { en: 'Vision Transformer', es: 'Vision Transformer' },
    type: { en: 'Computer Vision', es: 'Visión por Computador' },
  ...
  },
  {
    ...
    fullName: { en: 'Autoencoder', es: 'Autoencoder' },
    ...
    architecture: [
      { en: 'Input', es: 'Entrada' },
      { en: 'Encoder (downsampling)', es: 'Encoder (downsampling)' },
      { en: 'Latent bottleneck', es: 'Cuello de botella latente' },
      { en: 'Decoder (upsampling)', es: 'Decoder (upsampling)' },
