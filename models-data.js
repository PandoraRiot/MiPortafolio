...
window.MODEL_LAB = [
  {
    ...
    architecture: [
      ...
      { en: 'Convolutional backbone (ResNet / EfficientNet family)', es: 'Red base convolucional (familia ResNet / EfficientNet)' },
      { en: 'Batch norm + ReLU blocks', es: 'Bloques de normalización por lotes + ReLU' },
      { en: 'Global average pooling', es: 'Agrupamiento promedio global' },
    ...
    dataset: {
      ...
      es: 'Comparativa con imágenes de frutas (Diplomado IA, UdeA + Talento Tech) para el estudio de varias arquitecturas; recortes de la región de interés (ROI) de DCE-MRI para la comparación de redes base de la tesis — ver el caso de estudio DCE-MRI para el detalle de ese conjunto de datos.',
    },
    training: {
      ...
      es: 'Clasificación de frutas: entrenamiento comparativo de 3+ arquitecturas CNN con análisis de sobreajuste y verificación de generalización. DCE-MRI: redes base candidatas entrenadas con validación cruzada de 5 particiones sobre el subconjunto de entrenamiento estratificado.',
    },
    metrics: null,
    metricsNote: {
      ...
      es: 'Las métricas de la comparativa de frutas fueron internas al curso (curvas de exactitud y sobreajuste, no publicadas). Los resultados de las redes base CNN de la tesis se reportan en el caso de estudio DCE-MRI, no se duplican aquí.',
    },
  ...
  },
  {
    ...
    architecture: [
      ...
      { en: 'Transformer encoder blocks (global self-attention)', es: 'Bloques codificadores Transformer (autoatención global)' },
    ...
    dataset: {
      ...
      es: 'Mismo conjunto de datos de ROI DCE-MRI y partición estratificada a nivel de paciente usados en toda la comparación de redes base de la tesis.',
    },
    training: {
      ...
      es: 'Entrenado como uno de los candidatos dentro de la comparación de arquitecturas con validación cruzada de 5 particiones; se guardó un punto de control de la mejor partición para evaluación posterior.',
    },
    metrics: null,
    metricsNote: {
  ...
  },
  {
    ...
    architecture: [
      { en: 'Input features (scaled)', es: 'Características de entrada (escaladas)' },
      { en: 'Dense layer + activation', es: 'Capa densa + activación' },
      { en: 'Dense layer + activation', es: 'Capa densa + activación' },
      { en: 'Output layer', es: 'Capa de salida' },
    ],
    dataset: { en: 'To be defined — likely the same tabular sets used in the classical ML benchmark, for a direct comparison.', es: 'Por definir — probablemente los mismos conjuntos tabulares usados en la comparativa de ML clásico, para una comparación directa.' },
    training: null, metrics: null, metricsNote: null,
    repo: null, repoLabel: null, demo: null,
    inference: { input: { en: 'Feature vector (tabular row)', es: 'Vector de características (fila tabular)' }, output: { en: 'Class prediction', es: 'Predicción de clase' } },
    api: null,
  },
  {
    slug: 'rnn',
  ...
  },
  {
    ...
    order: '04',
    shortName: 'LSTM',
    fullName: { en: 'Long Short-Term Memory', es: 'Memoria a largo y corto plazo' },
    type: { en: 'Sequence Learning', es: 'Aprendizaje de Secuencias' },
    framework: 'PyTorch',
  ...
  },
  {
    ...
    order: '05',
    shortName: 'GRU',
    fullName: { en: 'Gated Recurrent Unit', es: 'Unidad recurrente con compuertas' },
    type: { en: 'Sequence Learning', es: 'Aprendizaje de Secuencias' },
    framework: 'PyTorch',
  ...
  },
  {
    ...
    architecture: [
      { en: 'Input', es: 'Entrada' },
      { en: 'Encoder (downsampling)', es: 'Codificador (reducción de resolución)' },
  ...
  },
  {
    ...
    architecture: [
      ...
      { en: 'Readout function', es: 'Función de lectura del grafo' },
      { en: 'Node / graph prediction', es: 'Predicción de nodo / grafo' },
    ],
    dataset: null, training: null, metrics: null, metricsNote: null,
    repo: null, repoLabel: null, demo: null,
    inference: { input: { en: 'Graph (nodes, edges, features)', es: 'Grafo (nodos, aristas, características)' }, output: { en: 'Node or graph-level prediction', es: 'Predicción a nivel de nodo o grafo' } },
    api: null,
  },
];
