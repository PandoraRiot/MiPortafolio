...
window.EXPERIENCE = {
  ui: {
    ...
    evolution: [
      ...
      { en: 'Backend / Full Stack',     es: 'Servidor / desarrollo integral' },
      { en: 'Data',                     es: 'Datos' },
      ...
      items: [
        {
          ...
          context: { en: 'Contractor', es: 'Contratista' },
          date: { en: 'Jul 2025 — Oct 2025', es: 'Jul 2025 — Oct 2025' },
          desc: {
            en: 'Administration and development of institutional web platforms: content and feature maintenance, usability improvements and support for digital-transformation initiatives.',
            es: 'Administración y desarrollo de plataformas web institucionales: mantenimiento de contenidos y funcionalidades, mejoras de usabilidad y apoyo a iniciativas de transformación digital.',
          },
          points: [
          ...
          tech: ['HTML', 'CSS', 'JavaScript', 'WordPress', 'Moodle', { en: 'Responsive design', es: 'Diseño responsivo' }],
        },
        {
          id: 'servisoft',
      ...
      items: [
        {
          ...
          date: { en: 'Feb 2026 — Jul 2026', es: 'Feb 2026 — Jul 2026' },
          desc: {
