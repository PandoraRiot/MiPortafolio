...
| 🎓 **Formación** | Ingeniería de Software (egresada; grado en dic 2026), diplomados en Ciencia de Datos, Arquitectura en la Nube (avanzado) e IA, Programación Web (UPB) y Técnica en Mantenimiento de Equipos de Cómputo (SENA) — **toda mi formación ha sido con becas por excelencia** (Sapiencia, Presupuesto Participativo, Matrícula Cero y Nodo con Accenture). |
